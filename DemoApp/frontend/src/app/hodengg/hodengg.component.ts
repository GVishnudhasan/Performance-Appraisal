...
export class HodenggComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.researchDevelopment_Activities = fb.group({
      ...
      fdp_out: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      fdp_in: fb.control('', [Validators.required, Validators.min(0), Validators.max(15)]),
      workshop_seminar: fb.control('', [Validators.required, Validators.min(0), Validators.max(15)]),
      ugc_care_journal: fb.control('', [Validators.required, Validators.min(0), Validators.max(40)]),
      sci_ind_wos_journal: fb.control('', [Validators.required, Validators.min(0), Validators.max(40)]),
      national_intl_conference: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      book_publication: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      ...
      consultancy_work:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
    ...
    this.deptDevelopment_Activities = fb.group({
      ...
      placement_higher_edu:fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      ...
      ind_training:fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      ...
      grants_rec:fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      awards:fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),

    }),

    this.StudentDevelopment_Activities = fb.group({

      inplant_training:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      
      project_intern:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      cert_courses1:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      membership1:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      part_in_project:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      part_in_cocurr:fb.control('', [Validators.required, Validators.min(0), Validators.max(20)]),
      val_added:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      part_in_extracurr:fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
