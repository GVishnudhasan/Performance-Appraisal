  ...
  async mGeneratePDF() {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['Preparation of video material	l', this.categoryList.g2.prep_of_videomaterial.overall_total, this.categoryList.g2.prep_of_videomaterial.os1, this.categoryList.g2.prep_of_videomaterial.os2, this.categoryList.g2.prep_of_videomaterial.es1, this.categoryList.g2.prep_of_videomaterial.es2],
    ...
    doc.text('Skill Development Activities - 200', 10, 95);
    autoTable(doc, {
      head: [['Parameter', 'Total - 200', 'Mark obtained']],
      body: [
        ['Industrial Training Undergone(Min. 2 Days)'],
        ['Training at Industry', this.categoryList1.g1.training_at_industry.overall_total,this.categoryList1.g1.training_at_industry.marks],
        ...
        ['Outcome achieved (Mini Project/Case Study/ Paper Presentation etc) (each-5)', this.categoryList1.g2.outcome_achieved.overall_total,this.categoryList1.g2.outcome_achieved.marks],
