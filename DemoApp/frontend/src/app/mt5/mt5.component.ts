...
export class Mt5Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.academic_Activities = fb.group({
      ...
      gate_or_refbook_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      gate_or_refbook_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      gate_or_refbook_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      gate_or_refbook_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      ...
      on_time_sub_qp_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(5)]),
      on_time_sub_qp_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(5)]),
      on_time_sub_qp_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(5)]),
      on_time_sub_qp_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(5)]),
      ...
      using_various_ptm_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      using_various_ptm_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      using_various_ptm_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      using_various_ptm_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      ...
      lab_manual_prep_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      lab_manual_prep_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      lab_manual_prep_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      lab_manual_prep_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      ...
      content_beyond_syll_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      content_beyond_syll_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      content_beyond_syll_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      content_beyond_syll_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      ...
      a_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      a_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      a_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      a_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      ...
      c_os1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      c_os2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      c_es1: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      c_es2: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
    ...
    this.skillDevelopment_Activities = fb.group({
      ...
      training_tier_1_ind: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      training_tier_2_tier_3_ind: fb.control('', [Validators.required, Validators.min(0), Validators.max(5)]),
      training_outcome: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      guest_lecture: fb.control('', [Validators.required, Validators.min(0), Validators.max(40)]),
      ...
      vac_faculty_industry: fb.control('', [Validators.required, Validators.min(0), Validators.max(40)]),
      vac_industry_resources: fb.control('', [Validators.required, Validators.min(0), Validators.max(40)]),
    ...
    this.researchDevelopment_Activities = fb.group({
      ...
      course_comp_cert_elite: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      fdp_out: fb.control('', [Validators.required, Validators.min(0), Validators.max(20)]),
      fdp_in: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      workshop_seminar: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      peer_reviewed_journal: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
      ugc_care_journal: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      sci_ind_wos_journal: fb.control('', [Validators.required, Validators.min(0), Validators.max(40)]),
      ...
      consultancy_work_less: fb.control('', [Validators.required, Validators.min(0), Validators.max(10)]),
    ...
    this.administrativeExtension_Activities = fb.group({
      dept_lvl_resp: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      rating_for_eff_hod: fb.control('', [Validators.required, Validators.min(0), Validators.max(20)]),
      ins_lvl_resp: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
      rating_for_eff_pric: fb.control('', [Validators.required, Validators.min(0), Validators.max(20)]),
      part_ext_act: fb.control('', [Validators.required, Validators.min(0), Validators.max(30)]),
