...
export class Mt5Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    (this.academic_Activities = fb.group({
      ...
      (this.skillDevelopment_Activities = fb.group({
        training_tier_1_ind: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(10),
        ]),
        training_tier_2_tier_3_ind: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(5),
        ]),
      ...
      (this.researchDevelopment_Activities = fb.group({
        ...
        consultancy_work_more: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        init_tow_start: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
  ...
  async opt_data() {
    ...
    this.consolidatedScore =
      this.obtainedScoreG1 +
  ...
  async mGeneratePDF3() {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          "Consultancy work (less than 1 lakh)",
          this.categoryList2.g7.consultancy_work_less.overall_total,
          this.categoryList2.g7.consultancy_work_less.marks,
        ],
        [
          "Consultancy work(more than 1 lakh)",
          this.categoryList2.g7.consultancy_work_more.overall_total,
          this.categoryList2.g7.consultancy_work_more.marks,
        ],
        [
          "Initiative taken towards startup/incubation",
          this.categoryList2.g7.init_tow_start.overall_total,
          this.categoryList2.g7.init_tow_start.marks,
        ],
      ],
    });
  ...
  async GeneratePDF() {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          4,
          "Administrative and Extension Activites",
          200,
          65,
          this.obtainedScoreG4,
          this.flagG4,
        ...
        [
          5,
          "Rating by HoD, Director & Principal - 100",
          100,
          65,
          this.obtainedScoreG4,
          this.flagG4,
