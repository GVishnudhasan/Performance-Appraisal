...
export class WithphdComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    (this.academic_Activities = fb.group({
      ...
      (this.researchDevelopment_Activities = fb.group({
        ...
        sci_ind_wos_journal: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        ...
        one_five_lakh: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        more_than_five: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        ...
        consultancy_work_less: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
      ...
      (this.skillDevelopment_Activities = fb.group({
        training_at_t1: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        training_at_t23: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        ...
        vac_faculty_industry: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
      ...
      (this.ratingByHoDPrincipal = fb.group({
        dept_lvl_resp_1: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        doc_main_reg_upd: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        inv_dept_dev: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        comp_wrk_withot_follow: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
        rating_princi_manage: fb.control("", [
          Validators.required,
          Validators.min(0),
          Validators.max(20),
        ]),
  ...
  get f4() {
    return this.ratingByHoDPrincipal.controls;
  }
  ...
  async mGeneratePDF() {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          "1. 1. If Pass % is <60% - zero points 2. Score = (pass % x 80) + Average of increment/decrement in Internal Assesments",
        ...
        [
          "Certification in NPTEL/MOOCS A = 2 * (No. of students completed courses/Total no. of students) x 10",
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          ...
          this.categoryList1.g1.training_tier_1_ind.overall_total,
          this.categoryList1.g1.training_tier_1_ind.marks,
        ],
        [
          "Training at Tier-II/Tier-III industry",
          this.categoryList1.g1.training_tier_2_tier_3_ind.overall_total,
          this.categoryList1.g1.training_tier_2_tier_3_ind.marks,
        ],
        [
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          "SCI Indexed/Wos Journal	",
          this.categoryList2.g3.sci_ind_wos_journal.overall_total,
          this.categoryList2.g3.sci_ind_wos_journal.marks,
        ],
        ...
        [
          "1 lakh-5 lakhs(each-20)",
          this.categoryList2.g6.one_five_lakh.overall_total,
          this.categoryList2.g6.one_five_lakh.marks,
        ],
        [
          "More than 5 Lakhs",
          this.categoryList2.g6.more_than_five.overall_total,
          this.categoryList2.g6.more_than_five.marks,
        ],
        ...
        [
          "Consultancy work",
          this.categoryList2.g7.consultancy_work_less.overall_total,
          this.categoryList2.g7.consultancy_work_less.marks,
        ],
      ],
    });
    ...
    autoTable(doc, {
      ...
      body: [
        [
          "Dedication and Taking responsibility by self",
          this.categoryList4.g1.dept_lvl_resp.overall_total,
          this.categoryList4.g1.dept_lvl_resp.marks,
        ],
        [
          "Document Maintenance and regular Updation",
          this.categoryList4.g2.doc_main_reg_upd.overall_total,
          this.categoryList4.g2.doc_main_reg_upd.marks,
        ],
        [
          "Involvement towards department development",
          this.categoryList4.g3.inv_dept_dev.overall_total,
          this.categoryList4.g3.inv_dept_dev.marks,
        ],
        [
          "Completion of work on time without follow up",
          this.categoryList4.g4.comp_wrk_withot_follow.overall_total,
          this.categoryList4.g4.comp_wrk_withot_follow.marks,
        ],
        [
          "Ratiing by Principal/Mangement",
          this.categoryList4.g5.rating_princi_manage.overall_total,
          this.categoryList4.g5.rating_princi_manage.marks,
        ],
      ],
    });
