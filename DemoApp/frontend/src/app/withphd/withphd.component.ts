  ...
  async mGeneratePDF() {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['Standard of Prelab and Postlab Questions and Conduction', this.categoryList.g9.std_of_lab.overall_total, this.categoryList.g9.std_of_lab.os1, this.categoryList.g9.std_of_lab.os2, this.categoryList.g9.std_of_lab.es1, this.categoryList.g9.lab_manual_prep.es2],
        ...
        ['Certification in NPTEL/MOOCS A = 2 * (No. of students completed courses/Total no. of students) x 10', this.categoryList.g10.a.overall_total, this.categoryList.g10.a.os1, this.categoryList.g10.a.os2, this.categoryList.g10.a.es1, this.categoryList.g10.a.es2],
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['SCI Indexed/Wos Journal	',this.categoryList2.g3.sci_ind_wos_journal.overall_total,this.categoryList2.g3.sci_ind_wos_journal.marks],
        ...
        ['Consultancy work',this.categoryList2.g7.consultancy_work_less.overall_total,this.categoryList2.g7.consultancy_work_less.marks],
      ]
